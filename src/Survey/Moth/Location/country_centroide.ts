...
const COUNTRIES_CENTROID: Types = {
  ...
  GR: { lat: 39.074208, long: 21.824312, country: 'Greece', zoom: 6 },
  HU: {
    lat: 47.162494,
    long: 19.503304,
    country: 'Hungary',
  ...
  IE: { lat: 53.41291, long: -8.24389, country: 'Ireland', zoom: 6 },
  IT: { lat: 41.87194, long: 12.56738, country: 'Italy', zoom: 5 },
  LV: { lat: 56.879635, long: 24.603189, country: 'Latvia', zoom: 6 },
  LI: {
    lat: 47.166,
    long: 9.555373,
  ...
  RS: { lat: 44.016521, long: 21.005859, country: 'Serbia', zoom: 6 },
  SK: {
    lat: 48.669026,
    long: 19.699024,
    country: 'Slovakia',
